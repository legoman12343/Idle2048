...
public class SpendOrbs : MonoBehaviour
{
    ...
    public void init(int target, NotificationAnimation na, int questID)
    {
        ...
        bar.title.text = "Spend " + target + " Infusion Orbs";
        bar.description.text = "To complete this quest, spend " + target + " Infusion Orbs inside of the gear tab";
